...
This plot is extremely messy and contains a large number of results,
...
The component of the loading vector such as wisc.pr\$rotation\[,1\]
retrieves the loadings for PC1. These loadings are able to tell us how
much each feature contributes to a particular principal component.
...
My favorite is the ward.d2 method. I think it shows the cluster results
in a more organized and balanced way.
...
I think the k-means clustering show higher sensitivity, while the
hierarchical clustering shows higher specificity.
